...
![HumanMine with highlight over Lists](humanmine_highlighted.png)
...
![snoRNA lists](lists_with_snoRNA_toggled_hl.png)
...
`list page example on yeastmine.png` example - ADD Circling the Gnerate Python code button!!

![button that says 'Generate Python code'](list page example on yeastmine_hl.png)
...
![copy the code in the box](highlighted_python_code.png)
...
![click `launch` button](launch_binder_button_screen_hl.png)
